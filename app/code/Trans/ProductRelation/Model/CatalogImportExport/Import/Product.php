...
namespace Trans\ProductRelation\Model\CatalogImportExport\Import;
...
class Product extends \Magento\CatalogImportExport\Model\Import\Product
{
    ...
    protected $_linkNameToId = [
        ...
        '_combinations_' => \Trans\ProductRelation\Model\Catalog\Product\Link::LINK_TYPE_COMBINATIONS
    ];
    ...
    protected $_fieldsMap = [
        ...
        '_combinations_sku' => 'combinations_skus',
        '_combinations_position' => 'combinations_position',
    ];
