...
namespace Trans\ProductRelation\Block\Adminhtml\Catalog\Product\Edit\Tab;
 ...
 * Class Combinations
 */
class Combinations extends Extended
{
    /**
     * Core registry
     *
    ...
    {
        parent::_construct();
        $this->setId('combinations_product_grid');
    ...
    {
        return $this->getProduct() && $this->getProduct()->getCombinationsReadonly();
    }
    ...
    {
        $products = $this->getProductsCombinations();
        if (!is_array($products)) {
            $products = array_keys($this->getSelectedCombinationsProducts());
        }
        return $products;
    }

    /**
     * Retrieve Combinations products
     *
     * @return array
     */
    public function getSelectedCombinationsProducts()
    {
        $products = [];
        foreach ($this->_coreRegistry->registry('current_product')->getCombinationsProducts() as $product) {
