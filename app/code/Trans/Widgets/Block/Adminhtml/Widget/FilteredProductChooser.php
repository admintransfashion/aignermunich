...
class FilteredProductChooser extends \Magento\Backend\Block\Template
{
...
HTML;
    ...
    protected function _afterElementJs($element)
    {
        ...
        $filtertype = isset($config['filtertype']) ? $config['filtertype'] : 'bestseller';

        if($filtertype == 'new'){
            $chooserUrl = $this->getUrl('transwidgets/widget_instance/newproducts', []);
        }
        elseif($filtertype == 'featured'){
            $chooserUrl = $this->getUrl('transwidgets/widget_instance/featuredproducts', []);
        }
        else{
            $chooserUrl = $this->getUrl('transwidgets/widget_instance/bestsellerproducts', []);
        }
