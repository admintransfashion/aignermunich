...
class BestsellerProducts extends \Magento\Widget\Controller\Adminhtml\Widget\Instance
{
    /**
    ...
    public function execute()
    {
        ...
        $chooser = $this->_view->getLayout()->createBlock(
            \Trans\Widgets\Block\Adminhtml\Widget\Product\BestsellerChooser::class
        )->setName(
