 ...
 */
class ReservationItem extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init(ReservationItemInterface::TABLE_NAME, ReservationItemInterface::ID);
    }
