...
class Save extends \Trans\Reservation\Controller\Adminhtml\Config
{
    ...
    public function execute()
    {
        ...
        if($data) {
            $data[ReservationConfigInterface::CONFIG] = ReservationConfigInterface::CONFIG_HOURS;

            if(empty($data[ReservationConfigInterface::TITLE])) {
                $data[ReservationConfigInterface::TITLE] = $this->generateTitle(ReservationConfigInterface::CONFIG_HOURS);
            }
            ...
            $validateValue = $this->validateValue($data[ReservationConfigInterface::VALUE], ReservationConfigInterface::CONFIG_HOURS);
            ...
            if(!empty($data[ReservationConfigInterface::PRODUCT_SKU])) {
                ...
                $validateProduct = $this->validateProduct($data[ReservationConfigInterface::PRODUCT_SKU], ReservationConfigInterface::CONFIG_HOURS);
            ...
            if(!empty($data['data']['category_ids'])) {
                $validateCategory = $this->validateCategory($data['data']['category_ids'], ReservationConfigInterface::CONFIG_HOURS);
            ...
            try {
                ...
                $this->logger->info("Error save reservation hours. Message = " . $e->getMessage());
            } catch (\Exception $e) {
                $this->messageManager->addExceptionMessage($e, __('Something went wrong while saving reservation hours.'));
                $this->logger->info("Error save reservation hours. Message = " . $e->getMessage());
            }

            $this->logger->info("=========== End Save Reservation Hours =============");
