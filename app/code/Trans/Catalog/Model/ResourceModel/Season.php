...
namespace Trans\Catalog\Model\ResourceModel;
 ...
 * Class Season
 */
class Season extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init(SeasonInterface::TABLE_NAME, SeasonInterface::ID);
    }
